...
static void mavlink_test_sensor_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sensor_data_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.temp_container = packet_in.temp_container;
        packet1.hum_container = packet_in.hum_container;
        packet1.temp_control = packet_in.temp_control;
        packet1.hum_control = packet_in.hum_control;
        packet1.spare2 = packet_in.spare2;
        packet1.spare3 = packet_in.spare3;
        packet1.spare4 = packet_in.spare4;
        packet1.state_flag = packet_in.state_flag;
    ...
    mavlink_msg_sensor_data_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sensor_data_pack(system_id, component_id, &msg , packet1.temp_container , packet1.hum_container , packet1.temp_control , packet1.hum_control , packet1.state_flag , packet1.spare2 , packet1.spare3 , packet1.spare4 );
    mavlink_msg_sensor_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sensor_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.temp_container , packet1.hum_container , packet1.temp_control , packet1.hum_control , packet1.state_flag , packet1.spare2 , packet1.spare3 , packet1.spare4 );
    mavlink_msg_sensor_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sensor_data_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sensor_data_send(MAVLINK_COMM_1 , packet1.temp_container , packet1.hum_container , packet1.temp_control , packet1.hum_control , packet1.state_flag , packet1.spare2 , packet1.spare3 , packet1.spare4 );
    mavlink_msg_sensor_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
